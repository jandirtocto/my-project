  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{headerShown:false}}>
        ...
        <Stack.Screen name="RegisterFirstNameScreen" component={RegisterFirstNameScreen}/>
        <Stack.Screen name="RegisterLastNameScreen" component={RegisterLastNameScreen}/>
        <Stack.Screen name="RegisterNumberScreen" component={RegisterNumberScreen}/>
        <Stack.Screen name="RegisterConfirmPasswordScreen" component={RegisterConfirmPassowordScreen}/>
        <Stack.Screen name="RegisterPasswordScreen" component={RegisterPasswordcreen}/>
