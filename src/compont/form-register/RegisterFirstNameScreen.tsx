       ...
       <View style={styles.view}>
        ...
        <View style={{paddingVertical:30}}>
           ...
           <TextInput style={styles.input}
                      placeholder="to complete..." placeholderTextColor="#0F0F0F"  onChangeText={setFirstName} value={firstName} 
                      maxLength={15}  />
           <Text style={styles.textAlert} >{firstName.length===0?"campo requerido":null}{firstName.length===15?"minimo 10 caracteres":""}</Text>
        </View>
        <View  style={styles.viewButton}>
            <Button bolean={false} dirigir={()=>navigation.goBack()} />
            <Button bolean={true}  dirigir={()=>navigation.navigate("RegisterLastNameScreen",{email,password,confirmPassword,firstName})}
