...
export default function RegisterPasswordScreen({ navigation,route}:any){
    ...
    return(
       <View style={styles.view}>
        ...
        <Text style={styles.textAlert} >{password.length===0?"campo requerido":null}</Text>
        </View>
        <View  style={styles.viewButton}>
            <Button bolean={false} dirigir={()=>navigation.goBack()} />
            <Button bolean={true}  dirigir={()=>navigation.navigate("RegisterConfirmPasswordScreen",{email,password})}
